...
const LANGUAGES = {
    zh: {
        ...
        signin_time: '签到时间',
        signin_location: '签到位置',
        signin_status: '签到状态',
        no_records_for_date: '该日期没有签到记录',
        date: '日期',
        time: '时间',
        course: '课程',
        classroom: '教室',
    ...
    en: {
        ...
        signin_time: 'Sign-in Time',
        signin_location: 'Sign-in Location',
        signin_status: 'Sign-in Status',
        no_records_for_date: 'No sign-in records for this date',
        date: 'Date',
        time: 'Time',
        course: 'Course',
        classroom: 'Classroom',
